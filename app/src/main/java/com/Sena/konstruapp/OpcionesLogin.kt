...
import com.Sena.konstruapp.databinding.ActivityOpcionesLoginBinding
...
class OpcionesLogin : AppCompatActivity() {
    ...
    private lateinit var mGoogleSigningInClient : GoogleSignInClient
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            ...
            .requestEmail()
            .build()
        mGoogleSigningInClient = GoogleSignIn.getClient(this,gso)
    ...
    private fun googleLogin() {
        val googleSignInIntent = mGoogleSigningInClient.signInIntent
